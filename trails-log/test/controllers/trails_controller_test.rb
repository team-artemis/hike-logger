...
class TrailsControllerTest < ActionController::TestCase
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post :create, trail: { difficulty: @trail.difficulty, duration: @trail.duration, length: @trail.length, rating: @trail.rating, review: @trail.review, title: @trail.title }
    end
  ...
  test "should update trail" do
    patch :update, id: @trail, trail: { difficulty: @trail.difficulty, duration: @trail.duration, length: @trail.length, rating: @trail.rating, review: @trail.review, title: @trail.title }
    assert_redirected_to trail_path(assigns(:trail))
  end
